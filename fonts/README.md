 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [AdwaitaMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AdwaitaMono.zip)
   * [AdwaitaMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AdwaitaMono.tar.xz) (smaller)
